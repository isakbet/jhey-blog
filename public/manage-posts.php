                            ...
                            <div class="table-responsive table mt-2" id="dataTable" role="grid" aria-describedby="dataTable_info">
                                <table class="table dataTable my-0" id="dataTable">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                        // $sql = "SELECT posts.title,posts.id FROM posts";
                                        ...
                                        $status = 1;
                                        $sql =
                                            "SELECT title,posts.id FROM posts WHERE posts.userid =:uid AND posts.status=:status";
                                        $query = $pdo->prepare($sql);
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="edit-post.php?id=<?php echo htmlentities($result->id); ?>">Edit</a></td>
                                                    <td><a href="manage-posts.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to delete?');">delete</a>
                                                    </td>
                                                </tr>
                                        <?php $cnt = $cnt + 1;
                                            }
