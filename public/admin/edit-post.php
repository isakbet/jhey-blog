                                    ...
                                    <div class="col">
                                        <div class="card shadow mb-3">
                                            ...
                                            <div class="card-body">
                                                <?php
                                                $id = intval($_GET['id']);
    $sql = "SELECT posts.* FROM posts WHERE posts.id=:id";
    $query = $pdo->prepare($sql);
    $query->bindParam(':id', $id, PDO::PARAM_STR);
    $query->execute();
                                                    ...
                                                    <div class="form-group">
                                                        <div class="form-row">
                                                            <div class="col-md-12 col-lg-12 col-xl-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="textarea2"><strong>Author</strong></label>
                                                                    <textarea class="form-control" id="textarea2"
                                                                              rows="4" name="grabber"
                                                                              style="height: 70px;"
                                                                              required><?php echo htmlentities($result->author); ?></textarea>
                                                                </div>

                                                                <div class="form-group">
                                                                    <label for="textarea1"><strong>Content</strong></label>
                                                                    <textarea class="form-control" id="textarea1"
                                                                              rows="4" name="desc"
                                                                              style="height: 200px;"
                                                                              required><?php echo htmlentities($result->content); ?></textarea>
                                                                </div>
