                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-8 col-lg-6 col-xl-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" id="pagename" type="text" name="pagename" value="<?php echo htmlentities($result->pagename); ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="col-md-8 col-lg-6 col-xl-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input class="form-control" id="pagetype" type="text" name="pagetype" value="<?php echo htmlentities($result->pagetype); ?>" required>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="form-row">
                                                                    <div class="col-md-12 col-lg-12 col-xl-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea class="form-control" id="textarea1" rows="4" name="desc" style="height: 200px;" required><?php echo htmlentities($result->description); ?></textarea>
                                                                        </div>
