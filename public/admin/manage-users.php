                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="manage-users.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to delete?');">delete</a>
                                                        </td>
                                                    </tr>
                                            <?php $cnt = $cnt + 1;
                                                }
                                            ...
                                            if ($query->rowCount() > 0) {
                                                foreach ($results as $result) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo htmlentities($name); ?></td>
                                                        <td><?php echo htmlentities($result->email); ?></td>
                                                        <td><a href="manage-users.php?uaid=<?php echo $result->id; ?>" onclick="return confirm('Do you want to approve this user?');">approve</a>
                                                        </td>
                                                        <td><a href="manage-users.php?del=<?php echo $result->id; ?>" onclick="return confirm('Do you want to delete?');">delete</a>
                                                        </td>
                                                    </tr>
