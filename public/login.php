                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="p-5">
                                        ...
                                        <hr>
                                        <div class="text-center">
                                            <a href="view-posts.php" class="btn btn-info btn-block text-white btn-user">View Posts</a>
                                        </div>
                                        <div class="text-center">
                                            <hr>
                                            <a href="#" class="btn btn-warning btn-block text-black-50 btn-user disabled">Forgot Password?</a>
                                        </div>
                                        <hr>
                                        <div class="text-center">
