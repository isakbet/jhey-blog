    ...
    <article>
        <div class="container">
            <div class="row">
                ...
                $s = 1;
                $sql = "SELECT posts.* FROM posts WHERE posts.status=:s ORDER BY posts.id DESC LIMIT $offset, $total_records_per_page";
                        ...
                        <div class="col-md-10 col-lg-12">
                            <div class="post-preview">
                                <a href="post-details.php?id=<?php echo htmlentities($result->id); ?>">
                                    ...
                                    <h3 class="post-subtitle"><?php echo htmlentities($result->content); ?></h3>
                                </a>
